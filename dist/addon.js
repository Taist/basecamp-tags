...
var Q, app, appData, extend, generateGUID, proxy;
...
app = {
  ...
  initProxy: function() {
    return proxy.onRequestFinish(function(request) {
      var account, dst, ref, src, todoTags, url;
      ...
      if (url.match(/\/completed$/)) {
        ...
        ref = app.materialize, src = ref.src, dst = ref.dst;
        if (request.response.indexOf('When a project is materizlied from a template')) {
          if (request.response.indexOf("/" + account + "/projects/" + dst)) {
            app.materialize = {};
            return Q.all([$.get("/" + account + "/projects/" + src + "?from_workspace=42"), $.get("/" + account + "/projects/" + dst + "?from_workspace=42")]).spread(function(src, dst) {
              var dstTodos, sourceTags;
              sourceTags = src.match(/\/todos\/\d+\/edit/g).map(function(t) {
                return appData.todosIndex["todo_" + (t.match(/\d+/)[0])];
              });
              dstTodos = dst.match(/\/todos\/\d+\/edit/g).map(function(t) {
                return "todo_" + (t.match(/\d+/)[0]);
              });
              if (sourceTags.length === dstTodos.length) {
                sourceTags.forEach(function(tags, index) {
                  var todoId;
                  if (tags) {
                ...
                return app.exapi.updateCompanyData('todosTags', appData.todosIndex).then(function() {
                  return dstTodos.forEach(function(todoId) {
                    app.helpers.buildTagsLinks(todoId, appData.todosIndex[todoId]);
                    return app.basecamp.updateTodo(todoId);
                  });
                });
              } else {
                return app.api.log('Number of todos in the template and project doesn\'t match');
              }
            });
          }
        }
  ...
  actions: {
    ...
    onToggleFilter: function(isFilterExpanded) {
      ...
      return app.exapi.setUserData('options', app.options);
    }
  },
  basecamp: {},
  helpers: {
...
},{"./helpers/generateGUID":6,"./helpers/xmlHttpProxy":9,"q":20,"react/lib/DOMProperty":29,"react/lib/Object.assign":46}],2:[function(require,module,exports){
var app;
...
module.exports = {
  init: function(_app) {
    app = _app;
    app.basecamp.updateTodo = function(todoId) {
      return require('./updateTodo')(todoId);
    };
    return app.basecamp.updateControl = function() {
      return require('./showTagsControl')();
    };
  }
};

},{"./showTagsControl":3,"./updateTodo":4}],3:[function(require,module,exports){
var React, app, container;
...
},{"../app":1,"../react/basecamp/tagsControl":16,"react":175}],4:[function(require,module,exports){
...
},{"../app":1,"../react/basecamp/tagsButton":15,"../react/basecamp/tagsList":17,"react":175}],5:[function(require,module,exports){
...
module.exports = function(newElement, targetElement) {
  var parent;
  parent = targetElement != null ? targetElement.parentNode : void 0;
  if (parent) {
...
var _handleResponseByTimer, _listenForRequestFinish, _listenToRequests, _listening, _responseHandlers;
...
_listenToRequests = function() {
  ...
  return XMLHttpRequest.prototype.send = function() {
    _handleResponseByTimer(this);
    return originalSend.apply(this, arguments);
  };
};

_handleResponseByTimer = function(request) {
  var finished, handler, i, len, results;
  if (request.responseURL === '') {
    return setTimeout(function() {
      return _handleResponseByTimer(request);
    }, 200);
  } else {
...
var ColorPicker, React, colors, div;
...
ColorPicker = React.createFactory(React.createClass({
  ...
  onSelectColor: function(color) {
    return this.setState({
      ...
      return function() {
        var base;
        return typeof (base = _this.props).onSelectColor === "function" ? base.onSelectColor(color) : void 0;
      };
    })(this));
  },
  render: function() {
    return div({}, colors.map((function(_this) {
      return function(color, idx) {
        return div({
          key: color,
          onClick: function() {
            return _this.onSelectColor(color);
          },
          style: {
            cursor: 'pointer',
...
},{"react":175}],11:[function(require,module,exports){
var BasecampPopup, React, Styles, b, div, footer, label, ref, span;

React = require('react');

ref = React.DOM, span = ref.span, label = ref.label, b = ref.b, footer = ref.footer, div = ref.div;
...
},{"./styles":12,"react":175}],12:[function(require,module,exports){
...
},{"react/lib/Object.assign":46}],13:[function(require,module,exports){
var AwesomeIcons, React, Styles, Tag, span;
...
Tag = React.createFactory(React.createClass({
  onClick: function() {
    var base;
    return typeof (base = this.props).onClick === "function" ? base.onClick(this.props.tag.id, !this.props.isInactive) : void 0;
  },
  onEdit: function(event) {
    event.preventDefault();
    event.stopPropagation();
    return this.props.onEdit(this.props.tag);
  },
  render: function() {
    ...
    }, this.props.tag.name), this.props.onEdit != null ? span({
      style: {
        position: 'relative',
        marginLeft: 4,
        marginRight: 12
...
},{"../taist/awesomeIcons":18,"./styles":12,"react":175}],14:[function(require,module,exports){
var ColorPicker, React, TagEditor, a, button, div, extend, input, ref, span;

React = require('react');

extend = require('react/lib/Object.assign');

ref = React.DOM, div = ref.div, a = ref.a, input = ref.input, button = ref.button, span = ref.span;
...
TagEditor = React.createFactory(React.createClass({
  ...
  onSave: function() {
    var base, color, id, name, ref1, ref2, ref3;
    id = (ref1 = this.state.editedTag) != null ? ref1.id : void 0;
    color = (ref2 = this.state.selectedColor) != null ? ref2 : (ref3 = this.state.editedTag) != null ? ref3.color : void 0;
  ...
  componentWillReceiveProps: function(nextProps) {
    if (nextProps.editedTag) {
      return this.setState({
        ...
        return function() {
          var ref1;
          if ((nextProps.editedTag.name != null) && !_this.state.wasEdited) {
  ...
  render: function() {
    ...
    if (this.state.isEditorActive) {
      ...
      }), a(extend({}, actionProps, {
        onClick: this.onSave
      }), 'OK'), a(extend({}, actionProps, {
        onClick: this.onCancel
      }), 'Cancel'), ColorPicker({
        activeColor: (ref1 = this.state.selectedColor) != null ? ref1 : (ref2 = this.state.editedTag) != null ? ref2.color : void 0,
...
},{"./colorPicker":10,"react":175,"react/lib/Object.assign":46}],15:[function(require,module,exports){
...
dataAttrName = attrName.replace(/^data-/, '').replace(/-./g, function(a) {
...
TagsButton = React.createFactory(React.createClass({
  ...
  componentDidMount: function() {
    var mutationObserver, nubbin, todoNode;
    this.updateTagsList();
    todoNode = this.refs.tagsButton.getDOMNode().parentNode.parentNode.parentNode.parentNode;
    ...
    if (nubbin) {
      ...
      mutationObserver = new MutationObserver((function(_this) {
        return function(mutations) {
          if (nubbin.style.display === 'none' && (todoNode.className.match(/balloon_expanded/) == null)) {
      ...
      return mutationObserver.observe(nubbin, {
        attributes: true
      });
    }
  },
  ...
  onKeyDown: function(event) {
    if (event.keyCode === 27 && !event.target.tagName.match(/input/i)) {
      return this.onPopupClose();
    }
  },
...
},{"./popup":11,"./styles":12,"./tagEditor":14,"./tagsList":17,"react":175,"react/lib/DOMProperty":29,"react/lib/Object.assign":46}],16:[function(require,module,exports){
var AwesomeIcons, React, Tag, TagsControl, TagsList, div, extend, getElementRect, ref, span;
...
TagsControl = React.createFactory(React.createClass({
  ...
  onToggleFilter: function() {
    return this.setState({
      ...
      return function() {
        return _this.props.onToggleFilter(_this.state.isFilterExpanded);
      };
    })(this));
  },
  render: function() {
    ...
    return div({
      ...
      tag: this.state.tagsIndex[this.state.activeTags[0]],
      isInactive: false,
      onClick: this.onClickByTag
    })) : void 0), this.state.isFilterExpanded ? div({
      style: {
        marginTop: 8
      }
    }, TagsList({
...
},{"../../helpers/getElementRect":7,"../taist/awesomeIcons":18,"./tag":13,"./tagsList":17,"react":175,"react/lib/Object.assign":46}],17:[function(require,module,exports){
...
TagsList = React.createFactory(React.createClass({
  render: function() {
    var ref;
    if (((ref = this.props.tagsList) != null ? ref.length : void 0) > 0) {
      return div({
        style: {
          display: 'inline-block',
          marginRight: -4
        ...
        return function(tagId) {
          ...
          if (((ref1 = _this.props.tagsIndex) != null ? ref1[tagId] : void 0) != null) {
            ...
            return Tag(extend({
              tag: _this.props.tagsIndex[tagId]
            }, {
              isInactive: isInactive,
              onClick: onClick,
              onEdit: _this.props.onTagEdit
            }));
          } else {
            return null;
          }
...
},{"./tag":13,"react":175,"react/lib/Object.assign":46}],18:[function(require,module,exports){
...
icons = {
  black: {
    ...
    filter: '',
    ...
    'chevron-up': ''
  },
  gray40: {
...
},{"./CSSProperty":23,"./ExecutionEnvironment":40,"./camelizeStyleName":128,"./dangerousStyleValue":133,"./hyphenateStyleName":153,"./memoizeStringOnly":163,"./warning":174,"_process":19}],25:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":46,"./PooledClass":47,"./invariant":155,"_process":19}],26:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":31,"./ReactMultiChildUpdateTypes":92,"./invariant":155,"./setTextContent":169,"_process":19}],29:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":155,"_process":19}],30:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":29,"./quoteAttributeValueForBrowser":167,"./warning":174,"_process":19}],31:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":40,"./createNodesFromMarkup":132,"./emptyFunction":134,"./getMarkupWrap":147,"./invariant":155,"_process":19}],32:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./emptyFunction":134,"_process":19}],36:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventPluginRegistry":37,"./EventPluginUtils":38,"./accumulateInto":125,"./forEachAccumulated":140,"./invariant":155,"_process":19}],37:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":155,"_process":19}],38:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":34,"./invariant":155,"_process":19}],39:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":34,"./EventPluginHub":36,"./accumulateInto":125,"./forEachAccumulated":140,"_process":19}],40:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypes":98,"./invariant":155,"_process":19}],44:[function(require,module,exports){
(function (process){
/**
...
},{"./ReactBrowserEventEmitter":50,"./accumulateInto":125,"./forEachAccumulated":140,"./invariant":155,"_process":19}],45:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":155,"_process":19}],48:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./PooledClass":47,"./ReactFragment":83,"./traverseAllChildren":173,"./warning":174,"_process":19}],53:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactUpdateQueue":106,"./invariant":155,"./warning":174,"_process":19}],55:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":155,"_process":19}],57:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":46,"./emptyObject":135,"./warning":174,"_process":19}],59:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":77,"./ReactElementValidator":78,"./mapObject":162,"_process":19}],61:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSPropertyOperations":24,"./DOMProperty":29,"./DOMPropertyOperations":30,"./Object.assign":46,"./ReactBrowserEventEmitter":50,"./ReactComponentBrowserEnvironment":55,"./ReactMount":90,"./ReactMultiChild":91,"./ReactPerf":95,"./escapeTextContentForBrowser":136,"./invariant":155,"./isEventSupported":156,"./keyOf":161,"./warning":174,"_process":19}],63:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSPropertyOperations":24,"./DOMChildrenOperations":28,"./DOMPropertyOperations":30,"./ReactMount":90,"./ReactPerf":95,"./invariant":155,"./setInnerHTML":168,"_process":19}],65:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusMixin":21,"./DOMPropertyOperations":30,"./LinkedValueUtils":43,"./Object.assign":46,"./ReactBrowserComponentMixin":49,"./ReactClass":53,"./ReactElement":77,"./ReactMount":90,"./ReactUpdates":107,"./invariant":155,"_process":19}],68:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactBrowserComponentMixin":49,"./ReactClass":53,"./ReactElement":77,"./warning":174,"_process":19}],69:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusMixin":21,"./DOMPropertyOperations":30,"./LinkedValueUtils":43,"./Object.assign":46,"./ReactBrowserComponentMixin":49,"./ReactClass":53,"./ReactElement":77,"./ReactUpdates":107,"./invariant":155,"./warning":174,"_process":19}],73:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":46,"./ReactContext":58,"./ReactCurrentOwner":59,"./warning":174,"_process":19}],78:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactCurrentOwner":59,"./ReactElement":77,"./ReactFragment":83,"./ReactNativeComponent":93,"./ReactPropTypeLocationNames":96,"./ReactPropTypeLocations":97,"./getIteratorFn":146,"./invariant":155,"./warning":174,"_process":19}],79:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":77,"./ReactInstanceMap":87,"./invariant":155,"_process":19}],80:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":77,"./warning":174,"_process":19}],84:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactRootIndex":103,"./invariant":155,"_process":19}],87:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":46,"./invariant":155,"_process":19}],94:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":155,"_process":19}],95:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":19}],97:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElementValidator":78,"./ReactRef":102,"_process":19}],102:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":77,"./ReactInstanceHandles":86,"./ReactMarkupChecksum":89,"./ReactServerRenderingTransaction":105,"./emptyObject":135,"./instantiateReactComponent":154,"./invariant":155,"_process":19}],105:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":46,"./ReactCurrentOwner":59,"./ReactElement":77,"./ReactInstanceMap":87,"./ReactLifeCycle":88,"./ReactUpdates":107,"./invariant":155,"./warning":174,"_process":19}],107:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":25,"./Object.assign":46,"./PooledClass":47,"./ReactCurrentOwner":59,"./ReactPerf":95,"./ReactReconciler":101,"./Transaction":123,"./invariant":155,"./warning":174,"_process":19}],108:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":155,"_process":19}],124:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":155,"_process":19}],126:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactClass":53,"./ReactElement":77,"./invariant":155,"_process":19}],132:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":40,"./createArrayFromMixed":130,"./getMarkupWrap":147,"./invariant":155,"_process":19}],133:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":19}],136:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":59,"./ReactInstanceMap":87,"./ReactMount":90,"./invariant":155,"./isNode":157,"./warning":174,"_process":19}],138:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./traverseAllChildren":173,"./warning":174,"_process":19}],139:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":40,"./invariant":155,"_process":19}],148:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":46,"./ReactCompositeComponent":57,"./ReactEmptyComponent":79,"./ReactNativeComponent":93,"./invariant":155,"./warning":174,"_process":19}],155:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":19}],156:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":155,"_process":19}],161:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":77,"./invariant":155,"_process":19}],165:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./warning":174,"_process":19}],172:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":155,"_process":19}],173:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":77,"./ReactFragment":83,"./ReactInstanceHandles":86,"./getIteratorFn":146,"./invariant":155,"./warning":174,"_process":19}],174:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./emptyFunction":134,"_process":19}],175:[function(require,module,exports){
...
addonEntry = {
  start: function(_taistApi, entryPoint) {
    ...
    return Q.all([app.exapi.getUserData('options'), app.helpers.loadAllTags()]).spread(function(options) {
      ...
      app.elementObserver.waitElement('section.todos', function(section) {
...
},{"./app":1,"./basecamp/basecampTags":2,"./basecamp/showTagsControl":3,"./helpers/domObserver":5,"./helpers/insertAfter":8,"q":20,"react/lib/Object.assign":46}]},{},[]);
